...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        List<NetflixDataModel> inputList = fileParser.processInputFile(path);
    ...
    private static void getNetflixData(NetflixFilterService netflixFilterService, List<NetflixDataModel> inputList, String type, String listedIn, String country, Date inputDate, Date inputToDate, int n) {
        //To get Data by Type
        System.out.println(type + " data");
        List<NetflixDataModel> dataByType = netflixFilterService.getDataByType(inputList, type, inputDate, inputToDate, n);
        dataByType.forEach(x -> System.out.println(x.toString() + " "));

        // To get Data by Listed in
        System.out.println("\n" + listedIn + " data");
        List<NetflixDataModel> dataByListedIn = netflixFilterService.getDataByListedIn(inputList, listedIn, inputDate, inputToDate, n);
        dataByListedIn.forEach(x -> System.out.println(x.toString() + " "));

        // To get Data by Country name and type
        System.out.println("\n" + type + " " + country + " data");
        List<NetflixDataModel> dataByTypeAndCountry = netflixFilterService.getDataByTypeAndCountry(inputList, type, country, inputDate, inputToDate, n);
        dataByTypeAndCountry.forEach(x -> System.out.println(x.toString() + " "));


        //To get data by date
        System.out.println("\n" + "Data between date");
        List<NetflixDataModel> dataByDate = netflixFilterService.getDataByDate(inputList, inputDate, inputToDate, n);
